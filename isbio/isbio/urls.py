...
if not is_on():
	...
	urlpatterns = patterns('',
		...
		url(r'^test/status/log/?$', views.view_log_test),
		url(r'^test/status/log/all/?$', views.view_log_test, { 'show_all': True }),
		url(r'^test/status/log/(?P<num>\d+)/?$', views.view_log_test),
		url(r'^test/streaming/?$', views.stream_response),
